...
object LibraryConstants {
    ...
    val ALL_LIBRARIES =
        CORE_ANDROID_LIBRARIES + HILT_LIBRARIES + VIEW_LIBRARIES + COMPOSE_LIBRARIES + TESTING_LIBRARIES +
            COMPOSE_TESTING_LIBRARIES + NETWORK_LIBRARIES + TEST_MOCKITO_LIBRARIES + TEST_KOTLINX_COROUTINES +
            TEST_ANDROID_HILT
}
