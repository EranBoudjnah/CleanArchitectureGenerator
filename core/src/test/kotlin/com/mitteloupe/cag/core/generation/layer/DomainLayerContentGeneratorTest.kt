...
class DomainLayerContentGeneratorTest {
    ...
    fun setUp() {
        ...
        temporaryDirectory = createTempDirectory(prefix = "DomainLayerContentGeneratorTest").toFile()
    }
...
"""
        val useCaseFile =
            File(featureRoot, "domain/src/main/java/com/example/feature/domain/usecase/PerformActionUseCase.kt")
...
"""
        val repositoryFile =
            File(featureRoot, "domain/src/main/java/com/example/feature/domain/repository/PerformActionRepository.kt")
...
"""
    ...
    fun `Given valid parameters when generateUseCase then creates use case file with correct content`() {
        // Given
        val destinationDirectory = File(temporaryDirectory, "src/main/java/com/example/feature/domain/usecase")
