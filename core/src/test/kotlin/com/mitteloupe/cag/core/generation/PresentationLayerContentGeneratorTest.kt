...
class PresentationLayerContentGeneratorTest {
    ...
    @Before
    fun setUp() {
        classUnderTest = PresentationLayerContentGenerator()
...
"""
        val modelFile = File(featureRoot, "presentation/src/main/java/com/example/feature/presentation/model/StubPresentationModel.kt")
...
"""
        val viewStateFile = File(featureRoot, "presentation/src/main/java/com/example/feature/presentation/model/TestViewState.kt")
